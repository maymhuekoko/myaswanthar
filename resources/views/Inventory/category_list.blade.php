...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">        
        <h2 class="font-weight-bold">@lang('lang.category') @lang('lang.list')</h2>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body">
                <h4 class="card-title">@lang('lang.category') @lang('lang.list')</h4>
                        ...
                        <tbody id="category_table">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="btn btn-outline-warning" data-toggle="modal" data-target="#edit_item{{$category->id}}"><i class="far fa-edit"></i>
                                    @lang('lang.edit')</a>

                                    <a href="#" class="btn btn-outline-danger" onclick="ApproveLeave('{{$category->id}}')"><i class="mdi mdi-delete"></i>
                                    @lang('lang.delete')</a>
                                </td>
