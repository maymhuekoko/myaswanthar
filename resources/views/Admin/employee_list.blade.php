...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">        
        <h2 class="font-weight-bold">@lang('lang.employee') @lang('lang.list')</h2>
    </div>
        ...
        <div class="card card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9 m-l-3">
                    <h3 class="box-title m-b-0">{{$emp->user->name}}</h3> 
                        <small>User Code -> {{$emp->user->user_code}}</small><br/>
                        <small>Role -> {{$emp->user->role}} </small>
